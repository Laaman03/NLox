    ...
    public class AstGenerator : ISourceGenerator
    {
        ...
        private static readonly ClassDef stmt = new ClassDef
        {
            ...
            NestedClasses = new NestedClass[]
            {
                ...
                new NestedClass { Name = "Class",       Fields = "Token Name, List<Stmt.Function> Methods"},
            }
        };
        ...
        private static readonly ClassDef expr = new ClassDef
        {
            ...
            NestedClasses = new NestedClass[]
            {
                ...
                new NestedClass { Name = "Get",         Fields = "Expr Owner, Token Name" },
                new NestedClass { Name = "Set",         Fields = "Expr Owner, Token Name, Expr Value" },
                new NestedClass { Name = "Variable",    Fields = "Token Name"},
                new NestedClass { Name = "This",        Fields = "Token Keyword" },
